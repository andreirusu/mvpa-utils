...
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.cfg_named_dir.name = 'inputDir';
...
matlabbatch{2}.cfg_basicio.cfg_mkdir.parent(1).sname = 'Named Directory Selector: inputDir(1)';
matlabbatch{2}.cfg_basicio.cfg_mkdir.parent(1).src_exbranch = substruct('.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{2}.cfg_basicio.cfg_mkdir.parent(1).src_output = substruct('.','dirs', '{}',{1});
matlabbatch{2}.cfg_basicio.cfg_mkdir.name = 'PROC';
...
matlabbatch{3}.cfg_basicio.file_fplist.dir(1).sname = 'Named Directory Selector: inputDir(1)';
...
matlabbatch{3}.cfg_basicio.file_fplist.filter = '.*ima';
...
matlabbatch{4}.spm.util.dicom.data(1).sname = 'File Selector (Batch Mode): Selected Files (.*ima)';
...
matlabbatch{4}.spm.util.dicom.outdir(1).sname = 'Make Directory: Make Directory ''PROC''';
