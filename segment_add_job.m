...
matlabbatch{4}.cfg_basicio.file_fplist.filter = '^srf.*nii';
...
matlabbatch{5}.spm.spatial.coreg.write.ref(1).sname = 'File Selector (Batch Mode): Selected Files (^srf.*nii)';
...
matlabbatch{6}.spm.util.imcalc.output = 'rtrimmed_white.nii';
matlabbatch{6}.spm.util.imcalc.outdir = {''};
matlabbatch{6}.spm.util.imcalc.expression = 'i2 > 0.8';
...
matlabbatch{7}.spm.util.imcalc.output = 'rtrimmed_csf.nii';
matlabbatch{7}.spm.util.imcalc.outdir = {''};
matlabbatch{7}.spm.util.imcalc.expression = 'i3 > 0.8';
...
matlabbatch{8}.spm.spatial.smooth.data(1).sname = 'Coregister: Reslice: Resliced Images';
matlabbatch{8}.spm.spatial.smooth.data(1).src_exbranch = substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.spm.spatial.smooth.data(1).src_output = substruct('.','rfiles');
...
matlabbatch{9}.spm.util.imcalc.input(1).sname = 'Smooth: Smoothed Images';
matlabbatch{9}.spm.util.imcalc.input(1).src_exbranch = substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{9}.spm.util.imcalc.input(1).src_output = substruct('.','files');
matlabbatch{9}.spm.util.imcalc.output = 'rmask.nii';
matlabbatch{9}.spm.util.imcalc.outdir = {''};
matlabbatch{9}.spm.util.imcalc.expression = 'i1+i2 > 0.1';
