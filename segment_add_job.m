...
matlabbatch{4}.cfg_basicio.file_fplist.filter = '^ms.*nii$';
...
matlabbatch{5}.spm.spatial.preproc.data(1).sname = 'File Selector (Batch Mode): Selected Files (^ms.*nii$)';
...
matlabbatch{6}.spm.spatial.coreg.write.ref(1) = cfg_dep;
matlabbatch{6}.spm.spatial.coreg.write.ref(1).tname = 'Image Defining Space';
matlabbatch{6}.spm.spatial.coreg.write.ref(1).tgt_spec{1}(1).name = 'class';
matlabbatch{6}.spm.spatial.coreg.write.ref(1).tgt_spec{1}(1).value = 'cfg_files';
matlabbatch{6}.spm.spatial.coreg.write.ref(1).tgt_spec{1}(2).name = 'strtype';
matlabbatch{6}.spm.spatial.coreg.write.ref(1).tgt_spec{1}(2).value = 'e';
matlabbatch{6}.spm.spatial.coreg.write.ref(1).sname = 'File Selector (Batch Mode): Selected Files (^srf.*nii)';
matlabbatch{6}.spm.spatial.coreg.write.ref(1).src_exbranch = substruct('.','val', '{}',{3}, '.','val', '{}',{1});
matlabbatch{6}.spm.spatial.coreg.write.ref(1).src_output = substruct('.','files');
matlabbatch{6}.spm.spatial.coreg.write.source(1) = cfg_dep;
matlabbatch{6}.spm.spatial.coreg.write.source(1).tname = 'Images to Reslice';
matlabbatch{6}.spm.spatial.coreg.write.source(1).tgt_spec{1}(1).name = 'filter';
matlabbatch{6}.spm.spatial.coreg.write.source(1).tgt_spec{1}(1).value = 'image';
matlabbatch{6}.spm.spatial.coreg.write.source(1).tgt_spec{1}(2).name = 'strtype';
matlabbatch{6}.spm.spatial.coreg.write.source(1).tgt_spec{1}(2).value = 'e';
matlabbatch{6}.spm.spatial.coreg.write.source(1).sname = 'Segment: c1 Images';
matlabbatch{6}.spm.spatial.coreg.write.source(1).src_exbranch = substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{6}.spm.spatial.coreg.write.source(1).src_output = substruct('()',{1}, '.','c1', '()',{':'});
matlabbatch{6}.spm.spatial.coreg.write.source(2) = cfg_dep;
matlabbatch{6}.spm.spatial.coreg.write.source(2).tname = 'Images to Reslice';
matlabbatch{6}.spm.spatial.coreg.write.source(2).tgt_spec{1}(1).name = 'filter';
matlabbatch{6}.spm.spatial.coreg.write.source(2).tgt_spec{1}(1).value = 'image';
matlabbatch{6}.spm.spatial.coreg.write.source(2).tgt_spec{1}(2).name = 'strtype';
matlabbatch{6}.spm.spatial.coreg.write.source(2).tgt_spec{1}(2).value = 'e';
matlabbatch{6}.spm.spatial.coreg.write.source(2).sname = 'Segment: c2 Images';
matlabbatch{6}.spm.spatial.coreg.write.source(2).src_exbranch = substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{6}.spm.spatial.coreg.write.source(2).src_output = substruct('()',{1}, '.','c2', '()',{':'});
matlabbatch{6}.spm.spatial.coreg.write.source(3) = cfg_dep;
matlabbatch{6}.spm.spatial.coreg.write.source(3).tname = 'Images to Reslice';
matlabbatch{6}.spm.spatial.coreg.write.source(3).tgt_spec{1}(1).name = 'filter';
matlabbatch{6}.spm.spatial.coreg.write.source(3).tgt_spec{1}(1).value = 'image';
matlabbatch{6}.spm.spatial.coreg.write.source(3).tgt_spec{1}(2).name = 'strtype';
matlabbatch{6}.spm.spatial.coreg.write.source(3).tgt_spec{1}(2).value = 'e';
matlabbatch{6}.spm.spatial.coreg.write.source(3).sname = 'Segment: c3 Images';
matlabbatch{6}.spm.spatial.coreg.write.source(3).src_exbranch = substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{6}.spm.spatial.coreg.write.source(3).src_output = substruct('()',{1}, '.','c3', '()',{':'});
matlabbatch{6}.spm.spatial.coreg.write.roptions.interp = 0;
...
matlabbatch{7}.spm.util.imcalc.input(1).src_exbranch = substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
...
matlabbatch{9}.spm.spatial.smooth.data(1).sname = 'Coregister: Reslice: Resliced Images';
matlabbatch{9}.spm.spatial.smooth.data(1).src_exbranch = substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{9}.spm.spatial.smooth.data(1).src_output = substruct('.','rfiles');
...
matlabbatch{10}.spm.util.imcalc.input(1).sname = 'Smooth: Smoothed Images';
matlabbatch{10}.spm.util.imcalc.input(1).src_exbranch = substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{10}.spm.util.imcalc.input(1).src_output = substruct('.','files');
matlabbatch{10}.spm.util.imcalc.output = 'rmask.nii';
matlabbatch{10}.spm.util.imcalc.outdir = {''};
matlabbatch{10}.spm.util.imcalc.expression = 'i1+i2 > 0.1';
