...
matlabbatch{6}.spm.spatial.smooth.data(1).sname = 'Realign: Estimate & Reslice: Mean Image';
matlabbatch{6}.spm.spatial.smooth.data(1).src_exbranch = substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{6}.spm.spatial.smooth.data(1).src_output = substruct('.','rmean');
matlabbatch{6}.spm.spatial.smooth.fwhm = [6 6 6];
matlabbatch{6}.spm.spatial.smooth.dtype = 0;
matlabbatch{6}.spm.spatial.smooth.im = 0;
matlabbatch{6}.spm.spatial.smooth.prefix = 's';
matlabbatch{7}.cfg_basicio.cfg_save_vars.name = 'functional_preprocessing_data.mat';
matlabbatch{7}.cfg_basicio.cfg_save_vars.outdir(1) = cfg_dep;
matlabbatch{7}.cfg_basicio.cfg_save_vars.outdir(1).tname = 'Output Directory';
matlabbatch{7}.cfg_basicio.cfg_save_vars.outdir(1).tgt_spec{1}(1).name = 'filter';
matlabbatch{7}.cfg_basicio.cfg_save_vars.outdir(1).tgt_spec{1}(1).value = 'dir';
matlabbatch{7}.cfg_basicio.cfg_save_vars.outdir(1).tgt_spec{1}(2).name = 'strtype';
matlabbatch{7}.cfg_basicio.cfg_save_vars.outdir(1).tgt_spec{1}(2).value = 'e';
matlabbatch{7}.cfg_basicio.cfg_save_vars.outdir(1).sname = 'Named Directory Selector: subjectDir(1)';
matlabbatch{7}.cfg_basicio.cfg_save_vars.outdir(1).src_exbranch = substruct('.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{7}.cfg_basicio.cfg_save_vars.outdir(1).src_output = substruct('.','dirs', '{}',{1});
matlabbatch{7}.cfg_basicio.cfg_save_vars.vars.vname = 'filelist';
matlabbatch{7}.cfg_basicio.cfg_save_vars.vars.vcont(1) = cfg_dep;
matlabbatch{7}.cfg_basicio.cfg_save_vars.vars.vcont(1).tname = 'Variable Contents';
matlabbatch{7}.cfg_basicio.cfg_save_vars.vars.vcont(1).tgt_spec{1}(1).name = 'class';
matlabbatch{7}.cfg_basicio.cfg_save_vars.vars.vcont(1).tgt_spec{1}(1).value = 'cfg_files';
matlabbatch{7}.cfg_basicio.cfg_save_vars.vars.vcont(1).tgt_spec{1}(2).name = 'strtype';
matlabbatch{7}.cfg_basicio.cfg_save_vars.vars.vcont(1).tgt_spec{1}(2).value = 'e';
matlabbatch{7}.cfg_basicio.cfg_save_vars.vars.vcont(1).sname = 'File Selector (Batch Mode): Selected Files (^f.*nii$)';
matlabbatch{7}.cfg_basicio.cfg_save_vars.vars.vcont(1).src_exbranch = substruct('.','val', '{}',{3}, '.','val', '{}',{1});
matlabbatch{7}.cfg_basicio.cfg_save_vars.vars.vcont(1).src_output = substruct('.','files');
matlabbatch{7}.cfg_basicio.cfg_save_vars.saveasstruct = false;
