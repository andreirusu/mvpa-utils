...
matlabbatch{2}.spm.util.imcalc.output = 'T1c1c2.nii';
...
matlabbatch{3}.spm.util.checkreg.data(1).tgt_spec{1}(1).name = 'filter';
matlabbatch{3}.spm.util.checkreg.data(1).tgt_spec{1}(1).value = 'image';
...
matlabbatch{3}.spm.util.checkreg.data(1).sname = 'Segment: c1 Images';
matlabbatch{3}.spm.util.checkreg.data(1).src_exbranch = substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{3}.spm.util.checkreg.data(1).src_output = substruct('()',{1}, '.','c1', '()',{':'});
matlabbatch{3}.spm.util.checkreg.data(2) = cfg_dep;
matlabbatch{3}.spm.util.checkreg.data(2).tname = 'Images to Display';
matlabbatch{3}.spm.util.checkreg.data(2).tgt_spec{1}(1).name = 'filter';
matlabbatch{3}.spm.util.checkreg.data(2).tgt_spec{1}(1).value = 'image';
...
matlabbatch{3}.spm.util.checkreg.data(2).sname = 'Segment: c2 Images';
matlabbatch{3}.spm.util.checkreg.data(2).src_exbranch = substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{3}.spm.util.checkreg.data(2).src_output = substruct('()',{1}, '.','c2', '()',{':'});
matlabbatch{3}.spm.util.checkreg.data(3) = cfg_dep;
matlabbatch{3}.spm.util.checkreg.data(3).tname = 'Images to Display';
matlabbatch{3}.spm.util.checkreg.data(3).tgt_spec{1}(1).name = 'filter';
matlabbatch{3}.spm.util.checkreg.data(3).tgt_spec{1}(1).value = 'image';
matlabbatch{3}.spm.util.checkreg.data(3).tgt_spec{1}(2).name = 'strtype';
matlabbatch{3}.spm.util.checkreg.data(3).tgt_spec{1}(2).value = 'e';
matlabbatch{3}.spm.util.checkreg.data(3).sname = 'Segment: c3 Images';
matlabbatch{3}.spm.util.checkreg.data(3).src_exbranch = substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{3}.spm.util.checkreg.data(3).src_output = substruct('()',{1}, '.','c3', '()',{':'});
matlabbatch{3}.spm.util.checkreg.data(4) = cfg_dep;
matlabbatch{3}.spm.util.checkreg.data(4).tname = 'Images to Display';
matlabbatch{3}.spm.util.checkreg.data(4).tgt_spec{1}(1).name = 'filter';
matlabbatch{3}.spm.util.checkreg.data(4).tgt_spec{1}(1).value = 'image';
matlabbatch{3}.spm.util.checkreg.data(4).tgt_spec{1}(2).name = 'strtype';
matlabbatch{3}.spm.util.checkreg.data(4).tgt_spec{1}(2).value = 'e';
matlabbatch{3}.spm.util.checkreg.data(4).sname = 'Image Calculator: Imcalc Computed Image: T1c1c2.nii';
matlabbatch{3}.spm.util.checkreg.data(4).src_exbranch = substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{3}.spm.util.checkreg.data(4).src_output = substruct('.','files');
