...
matlabbatch{8}.spm.util.imcalc.input(1).src_exbranch = substruct('.','val', '{}',{7}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.spm.util.imcalc.input(1).src_output = substruct('.','rfiles');
matlabbatch{8}.spm.util.imcalc.output = 'brwROImask.nii';
matlabbatch{8}.spm.util.imcalc.outdir = {''};
matlabbatch{8}.spm.util.imcalc.expression = 'i1 > 0.1';
