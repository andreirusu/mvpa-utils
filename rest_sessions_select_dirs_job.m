...
matlabbatch{1}.cfg_basicio.cfg_named_dir.dirs = {{'/Users/andreirusu/mvpa/3_random_subjects/'}};
...
matlabbatch{2}.cfg_basicio.file_fplist.filter = '.*img';
...
matlabbatch{3}.cfg_basicio.file_filter.filter = 'rest';
