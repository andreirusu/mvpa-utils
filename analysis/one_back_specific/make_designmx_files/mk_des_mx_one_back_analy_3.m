function   mk_des_mx_one_back_analy_3(all_sub,param) %*change     need to address function file from file that loads up subject specific data ***_____________IF VARIABLES CHANGED *********
...
SPM.Sess(i).U(cond).P(1).h    = 2; %LINEAR
% 
