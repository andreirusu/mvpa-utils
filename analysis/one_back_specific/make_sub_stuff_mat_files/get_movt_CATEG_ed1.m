function [movt,all_movt_data]=get_movt_CATEG_ed1(task,param,my_name)
fs          = filesep; %file sep

dir_movtfile    = ['/Users/' my_name '/Documents/Retina_Self_FMRI_preproc_files'];%\Users\guitart\Experiments\RewPunGoN_Pharmcao'; %bse directory
sess_prfx   = 'sess';
...
for curr_sess=1:nsess %3 learning sessions
    scanDir = [dir_movtfile fs 's' num2str(curr_sub) fs 'categ' fs sess_prfx num2str(curr_sess)];
