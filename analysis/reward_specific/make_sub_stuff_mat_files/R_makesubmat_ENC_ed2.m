...
for z=1:num_subs
    ...
    for k=1:nsess %
        ...
        the_stuff.sess(k).reward_status=alltrials_split{k}(4,:);%1=rewarded, 0= unrewarded
    ...
    [movt,all_movt_data,param]=get_movt_R_ENC_ed2(the_stuff,param,my_name);
    %%
...
cd(dir_start)
save('sub_stuff_R_ENC_v3.mat','all_sub')
