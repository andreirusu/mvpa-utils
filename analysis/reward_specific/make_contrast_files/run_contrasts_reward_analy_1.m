function [param] = run_contrasts_reward_analy_1(param)
...
oth_pt=[0 0 0 ];%Feedback pos,neg,neut + TARG: event only
...
oth_pt=[1 1 -2 ];%Feedback pos,neg,neut + TARG: event only
...
cue_pt=[0 0  0 0];  %REW: event, mem rating UNREW: event, mem rating
oth_pt=[1 -1 0 ];%Feedback pos,neg,neut + TARG: event only
...
%NEXT CONTRAST
curr_num=curr_num+1;
param.all_con_names{curr_num}='chairs_vs_build'; %i.e. CHAIR vs BUILDINGS !!!
...
%NEXT CONTRAST
curr_num=curr_num+1;
param.all_con_names{curr_num}='build_vs_chairs';
...
%NEXT CONTRAST
curr_num=curr_num+1;
param.all_con_names{curr_num}='build_vs_chair'; %i.e. CHAIR vs BUILDINGS !!!
