function   mk_des_mx_reward_analy_2(all_sub,param) %*change     need to address function file from file that loads up subject specific data ***_____________IF VARIABLES CHANGED *********
...
%===========================================================================
Filter           = '^suf.*\.img$'; %smoothed normalized images

Directory1        =[dir_base fs 's' num2str(curr_sub) fs 'reward' fs 'sess1'];
Directory2        =[dir_base fs 's' num2str(curr_sub) fs 'reward' fs 'sess2'];
